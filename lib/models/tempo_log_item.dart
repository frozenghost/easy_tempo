...
class TempoLogItem extends Equatable  {
	...
	TempoLogItem({this.timeSpent, this.comment, this.tempoWorklogId, this.started, this.workerId, this.originTaskId, this.issue, this.timeSpentSeconds, this.billableSeconds, this.jiraWorklogId, this.dateCreated, this.dateUpdated, this.updaterId, this.originId, this.attributes});
